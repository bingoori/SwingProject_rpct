...
public final class SeatView2 extends JPanel {
	/**
	 * 
	 */
	...
	private final int totalCount = 72;
	...
	class SeatCountThread extends Thread {
		...
		public void run() {
			while (true) {
				...
				SeatInfo.setText("[ 남은 좌석:" + model.getSeatCount2() + "  /  총 좌석 :" + totalCount + " ]");
			}
